...
describe('getObjectTypeString', () => {
  ...
  const domTypes = [
    ['HTMLDivElement', document.createElement('div'), '[object HTMLDivElement]'],
    ['HTMLInputElement', document.createElement('input'), '[object HTMLInputElement]'],
    ['HTMLButtonElement', document.createElement('button'), '[object HTMLButtonElement]'],
    ['HTMLUListElement', document.createElement('ul'), '[object HTMLUListElement]'],
    ...
    ['DocumentFragment', document.createDocumentFragment(), '[object DocumentFragment]'],
